package com.cqecom.cms.components.sharedModuleReference;
...
@Properties(value = {
        @Property(name = "sling.servlet.paths", value = "/cqecom/genericSharedModules.json")
})
public class GenericSharedModulesOnPageServlet extends SlingSafeMethodsServlet {

    public static final Logger Log = LoggerFactory.getLogger(GenericSharedModulesOnPageServlet.class);
    ...
    private JSONArray getModules(SlingHttpServletRequest request) throws JSONException {
        ...
        if (StringUtils.isNotEmpty(page) && isPageInSharedContent(page,request)) {
            ...
            query.append("/jcr:root").append(page).append("//*[@sling:resourceType='cqecom/components/content/rsSharedModuleContainer']");
